...
import Pestrashop from "../page/service/ecommerece/Pestrashop.jsx";
import ServiceTemplate from "../components/common/Servicepage.jsx";
    ...
    children: [
      {
        ...
        children: [
          ...
          // },
          // {
          //   path: "/services/woo-commerce-development",
          //   element: <WooCommerceDevelopment />,
          // },
          {
            path: "/bigcommerce-development",
            element: <Navigate to="/services/bigcommerce-development" />,
          },
          {
            path: "/pestrashop",
            element: <Navigate to="/services/pestrashop" />,
          },
          {
            path: "/shift4shop-development",
            element: <Navigate to="/services/shift4shop-development" />,
          },
          {
            path: "/woo-commerce-development",
            element: <Navigate to="/services/woo-commerce-development" />,
          },
          // {
          // 	path: "/androidappdev",
